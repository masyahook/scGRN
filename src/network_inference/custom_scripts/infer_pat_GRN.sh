...
LOG_OUT=${LOG_OUTPUT}/${PATIENT}${TASK_NUM}${TF_SUFFIX}${CELL_TYPE_SUFFIX}_${METHOD}_${SLURM_JOBID}.out
LOG_ERR=${LOG_OUTPUT}/${PATIENT}${TASK_NUM}${TF_SUFFIX}${CELL_TYPE_SUFFIX}_${METHOD}_${SLURM_JOBID}.err

...
PATH2DATA=/gpfs/projects/bsc08/bsc08890/res/covid_19/cell_types/${CELL_TYPE}/data/Seurat/${INTEG_PREFIX}_data.tsv

GRN_ADJ=/gpfs/projects/bsc08/bsc08890/res/covid_19/cell_types/${CELL_TYPE}/data/${METHOD}/${INTEG_PREFIX}_data${TF_SUFFIX}.tsv
GRN_ADJ_COR=/gpfs/projects/bsc08/bsc08890/res/covid_19/cell_types/${CELL_TYPE}/data/${METHOD}/${INTEG_PREFIX}_data${TF_SUFFIX}_cor.tsv
OUTPUT=/gpfs/projects/bsc08/bsc08890/res/covid_19/cell_types/${CELL_TYPE}/data/${METHOD}/${INTEG_PREFIX}_data${TF_SUFFIX}_ctx.tsv
...
LOG_OUT=${LOG_OUTPUT}/${CELL_TYPE}${TASK_NUM}${TF_SUFFIX}_${INTEG_PREFIX}_pySCENIC_${METHOD}_${SLURM_JOBID}.out
LOG_ERR=${LOG_OUTPUT}/${CELL_TYPE}${TASK_NUM}${TF_SUFFIX}_${INTEG_PREFIX}_pySCENIC_${METHOD}_${SLURM_JOBID}.err
...
if [ -z "$PATH2TFLIST" ]; then
    ...
    python /gpfs/home/bsc08/bsc08890/src/run_pyscenic_on_all_genes.py -m $METHOD -i $PATH2DATA -o $GRN_ADJ --num_workers $NUM_WORKERS 2>> $LOG_ERR 1>> $LOG_OUT && \

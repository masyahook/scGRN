...
LOG_OUT=${LOG_OUTPUT}/${PATIENT}_type_${TASK_NUM}_${DATA}_COMMUNITY_ANA_${ALGO}_${SLURM_JOBID}.out
LOG_ERR=${LOG_OUTPUT}/${PATIENT}_type_${TASK_NUM}_${DATA}_COMMUNITY_ANA_${ALGO}_${SLURM_JOBID}.err
...
# Creating log files
printf "Performing community analysis cell type specific, pat type aggregated '${PATIENT}' (${DATA}) data with ${ALGO} algorithm..\n\n\n" > $LOG_OUT
printf "" > $LOG_ERR
